                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="" onsubmit="return confirm('Are you sure you want to delete this user?');" style="display:inline;">
                                    ...
                                    <button type="submit" name="delete_user_btn" class="action-btn btn-delete">
            ...
            <form method="POST" action="add_user.php" onsubmit="return validateForm()">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div>
                        ...
                        <input type="text" name="phone_number" required style="width: 100%; padding: 14px; border: 2px solid #e5e7eb; border-radius: 10px; font-size: 14px; transition: border-color 0.2s ease; background: white;" placeholder="Enter phone number">
                    </div>
