...
if (isset($_POST['action'])) {
    ...
    switch ($_POST['action']) {
        case 'get_client_details':
            ...
            $client_result = $conn->query("SELECT * FROM user_form WHERE id = $client_id AND user_type = 'client'");
        ...
        case 'get_client_cases':
            $client_id = intval($_POST['client_id']);
            $cases_result = $conn->query("SELECT * FROM client_cases WHERE client_id = $client_id ORDER BY created_at DESC");
            $cases = array();
        ...
        case 'get_client_documents':
            ...
            $docs_result = $conn->query("SELECT ad.*, ac.title as case_title 
