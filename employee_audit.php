...
$today_activities = $conn->query("SELECT COUNT(*) as count FROM employee_document_activity WHERE DATE(timestamp) = CURDATE()")->fetch_assoc()['count'];
$total_documents = $conn->query("SELECT COUNT(*) as count FROM employee_documents")->fetch_assoc()['count'];
$recent_activities = $conn->query("SELECT * FROM employee_document_activity ORDER BY timestamp DESC LIMIT 10")->fetch_all(MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="dashboard-section" style="margin-bottom: 30px;">
            ...
            <div class="dashboard-cards">
                ...
                <div class="card">
                    ...
                    <div class="card-info">
                        <h3>Uploads Today</h3>
                        <p><?= $conn->query("SELECT COUNT(*) as count FROM employee_document_activity WHERE action = 'Uploaded' AND DATE(timestamp) = CURDATE()")->fetch_assoc()['count'] ?></p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-icon">
